...
```
git clone https://github.com/foxsen/linux/tree/loongarch-qemu#clone linux repo with loongarch branch
...
在龙芯gdb-binutils里，找到opcodes/loongarch-opc.c的loongarch_macro_opcodes部分。每条指令具体的作用可以看opcodes/loongarch-coder.c的loongarch_expand_macro实现，以及gas/config/tc-loongarch.c的assember_macro_helper

关于其中一些宏定义，还需要全局搜索可以看到，比如在Documentation/asm-annotations.rst中有SYM_ENTRY的相关描述。

![image-20220325150908857](images/3.24-TODO-%E9%BE%99%E8%8A%AFqemu%E5%8F%8Aqemu-loongarch-runenv.assets/image-20220325150908857.png)



![image-20220325150937902](images/3.24-TODO-%E9%BE%99%E8%8A%AFqemu%E5%8F%8Aqemu-loongarch-runenv.assets/image-20220325150937902.png)
